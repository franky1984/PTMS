...
namespace Learun.Application.TwoDevelopment.LR_CodeDemo
{
    ...
    /// 描 述：黑名单管理
    /// </summary>
    public class BlackBLL : BlackIBLL
    {
        private BlackService blackService = new BlackService();
        ...
        public IEnumerable<F_Base_BlackListEntity> GetPageList(Pagination pagination, string queryJson)
        {
            try
            {
                return blackService.GetPageList(pagination, queryJson);
            }
            catch (Exception ex)
            {
        ...
        public F_Base_BlackListEntity GetF_Base_BlackListEntity(string keyValue)
        {
            try
            {
                return blackService.GetF_Base_BlackListEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void DeleteEntity(string keyValue)
        {
            try
            {
                blackService.DeleteEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
