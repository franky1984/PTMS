...
namespace Learun.Application.TwoDevelopment.LR_CodeDemo
{
    ...
    /// 描 述：打卡统计
    /// </summary>
    public class cardTJBLL : cardTJIBLL
    {
        private cardTJService cardTJService = new cardTJService();
        ...
        public IEnumerable<LR_Base_CardTJEntity> GetPageList(Pagination pagination, string queryJson)
        {
            try
            {
                return cardTJService.GetPageList(pagination, queryJson);
            }
            catch (Exception ex)
            {
        ...
        public LR_Base_CardTJEntity GetLR_Base_CardTJEntity(string keyValue)
        {
            try
            {
                return cardTJService.GetLR_Base_CardTJEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void DeleteEntity(string keyValue)
        {
            try
            {
                cardTJService.DeleteEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void SaveEntity(string keyValue, LR_Base_CardTJEntity entity)
        {
            try
            {
                cardTJService.SaveEntity(keyValue, entity);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
