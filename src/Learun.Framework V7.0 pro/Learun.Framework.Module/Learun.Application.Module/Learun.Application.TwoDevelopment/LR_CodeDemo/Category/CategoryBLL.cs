...
namespace Learun.Application.TwoDevelopment.LR_CodeDemo
{
    ...
    public class CategoryBLL : CategoryIBLL
    {
        ...
        public IEnumerable<LR_Base_CategoryEntity> GetPageList(Pagination pagination, string queryJson)
        {
            try
            {
                return categoryService.GetPageList(pagination, queryJson);
            }
            catch (Exception ex)
            {
        ...
        public LR_Base_CategoryEntity GetLR_Base_CategoryEntity(string keyValue)
        {
            try
            {
                return categoryService.GetLR_Base_CategoryEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void DeleteEntity(string keyValue)
        {
            try
            {
                categoryService.DeleteEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void SaveEntity(string keyValue, LR_Base_CategoryEntity entity)
        {
            try
            {
                categoryService.SaveEntity(keyValue, entity);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
