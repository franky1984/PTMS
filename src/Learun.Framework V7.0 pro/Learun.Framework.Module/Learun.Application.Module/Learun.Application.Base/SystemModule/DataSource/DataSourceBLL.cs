...
namespace Learun.Application.Base.SystemModule
{
    ...
    public class DataSourceBLL : DataSourceIBLL
    {
        ...
        /// <param name="showId">显示ID</param>
        /// <returns></returns>
        public List<TreeModel> GetOrdersTree(string code, string parentId, string Id, string showId)
        {
            try
            {
                DataSourceEntity entity = GetEntityByCode(code);
                ...
                {
                    DataTable list = databaseLinkIBLL.GetOrdersTree(entity.F_DbId, entity.F_Sql, new { });
                    List<TreeModel> treeList = new List<TreeModel>();
                    foreach (DataRow item in list.Rows)
                    {
                        TreeModel node = new TreeModel
