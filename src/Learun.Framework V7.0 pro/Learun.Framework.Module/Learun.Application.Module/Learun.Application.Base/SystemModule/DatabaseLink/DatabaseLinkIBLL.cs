...
namespace Learun.Application.Base.SystemModule
{
    ...
    public interface DatabaseLinkIBLL
    {
        ...
        void ExecuteBySql( string databaseLinkId, string sql, object dbParameter = null, string identity = "", string orderID = "", string realName = "", string categoryID = "", string gender = "", string employerID = "", string mobile = "");

        /// <summary>
        /// 判断用户是否在黑名单
        /// </summary>
        /// <param name="Identity"></param>
        int CheckBlack(string identity);

        /// <summary>
        /// 添加订单细表
        /// </summary>
        /// <param name="userId"></param>
        void InsertOrderDetail( string identity, string orderID = "", string realName = "", string categoryID = "", string gender = "", string employerID = "", string mobile="");
        ...
        DataTable GetOrdersTree(string databaseLinkId, string sql, object dbParameter = null);
        /// <summary>
