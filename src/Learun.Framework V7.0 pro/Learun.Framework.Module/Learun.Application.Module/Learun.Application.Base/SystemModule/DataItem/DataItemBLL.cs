...
namespace Learun.Application.Base.SystemModule
{
    ...
    public class DataItemBLL : DataItemIBLL
    {
        ...
        public List<DataItemEntity> GetClassifyList()
        {
            try
            {
                List<DataItemEntity> list = null;// cache.Read<List<DataItemEntity>>(cacheKeyClassify, CacheId.dataItem);
                if (list == null)
                {
        ...
        public List<DataItemDetailEntity> GetDetailList(string itemCode)
        {
            try
            {
                List<DataItemDetailEntity> list = null; //cache.Read<List<DataItemDetailEntity>>(cacheKeyDetail + itemCode, CacheId.dataItem);
                if (list == null)
                {
