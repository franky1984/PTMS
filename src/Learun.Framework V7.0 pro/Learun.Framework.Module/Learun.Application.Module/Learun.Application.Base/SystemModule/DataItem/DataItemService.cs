...
namespace Learun.Application.Base.SystemModule
{
    ...
    public class DataItemService : RepositoryFactory
    {
        ...
        #region 数据字典分类管理
        /// <summary>
        /// 分类列表  update ChengQing(只维护系统功能字典，其它的隐藏不维护)
        /// </summary>
        /// <returns></returns>
        public IEnumerable<DataItemEntity> GetClassifyList()
        {
            try
            {
                ...
                {
                    strSql.Append( "SELECT " + fieldSql + " FROM LR_Base_DataItem t WHERE ( t.f_itemid='7BCDCAA4-2C65-444A-9D04-57F990585C92' OR t.f_parentid='7BCDCAA4-2C65-444A-9D04-57F990585C92') AND t.F_DeleteMark = 0 Order By t.F_ParentId,t.F_SortCode " );
                }
                else
                {
