            ...
            $('#lr_verify').on('click', function () {
                ...
                if (taskType == 4) {
                    if (learun.checkrow(taskId)) {
                        learun.frameTab.open({ F_ModuleId: taskId, F_Icon: 'fa magic', F_FullName: '审批【' + processName + '/' + taskName + '】', F_UrlAddress: '/LR_WorkFlowModule/WfMyTask/CustmerWorkFlowForm?tabIframeId=' + taskId + '&type=4' + "&processId=" + processId + "&taskId=" + taskId });
                    }
                }
                else if (taskType == 1) {
                    if (learun.checkrow(taskId)) {
                        learun.frameTab.open({ F_ModuleId: taskId, F_Icon: 'fa magic', F_FullName: '审批【' + processName + '/' + taskName + '】', F_UrlAddress: '/LR_WorkFlowModule/WfMyTask/CustmerWorkFlowForm?tabIframeId=' + taskId + '&type=1' + "&processId=" + processId + "&taskId=" + taskId });
                    }
                }
                else if (taskType == 2) {
                    ...
                    if (learun.checkrow(taskId)) {
                        learun.frameTab.open({ F_ModuleId: taskId, F_Icon: 'fa magic', F_FullName: '审批【' + processName + '/' + taskName + '】', F_UrlAddress: '/LR_WorkFlowModule/WfMyTask/CustmerWorkFlowForm?tabIframeId=' + taskId + '&type=3' + "&processId=" + processId + "&taskId=" + taskId });
                    }
                }
            });
        },
